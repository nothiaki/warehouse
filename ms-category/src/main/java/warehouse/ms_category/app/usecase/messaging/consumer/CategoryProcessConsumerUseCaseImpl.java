...
@Service
public class CategoryProcessConsumerUseCaseImpl implements ConsumerUseCase {

  @Autowired
  private ProcessCategoryUseCase processCategoryUseCase;
  ...
  public void execute(String payload) {
    ...
    processCategoryUseCase.execute(history);
  }
